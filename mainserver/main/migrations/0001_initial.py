# Generated by Django 4.1.4 on 2023-11-26 11:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.tasksubmit')),
                ('test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.autotest')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
